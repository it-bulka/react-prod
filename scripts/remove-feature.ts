import {
  Node, Project, SyntaxKind, JsxAttribute
} from 'ts-morph'
...
if (!removedFeatureName) {
  throw new Error('Set feature-flag')
}

if (!featureState) {
  throw new Error('Set state of feature (on / off)')
}

if (featureState !== 'on' && featureState !== 'off') {
  throw new Error('Uncorrected feature state (on / off)')
}
